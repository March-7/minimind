...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="kxGPT Distill Reasoning")
    ...
    parser.add_argument("--wandb_project", type=str, default="kxGPT-Reason-Distill-SFT")
    ...
    args.wandb_run_name = f"kxGPT-Distill-Reasoning-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
